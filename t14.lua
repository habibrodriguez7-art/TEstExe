    ...
    do
                ...
                while _tjState.enabled do
                    ...
                    if #candidates > 0 then
                        ...
                        for _, candidate in ipairs(candidates) do
                            ...
                            tjSetStatus(
                                "Trying " .. triedCount .. "/" .. #candidates,
                                "Trying server...\n" .. info .. "\nJobId: " .. candidate.jobId
                            )
                            Library:MakeNotify({
                                Title       = "Treasure Hunt",
                                Description = "Trying server " .. triedCount .. "/" .. #candidates .. "... " .. info,
                                Delay       = 2,
                            })
                            ...
                            if ok then
                                ...
                                tjSetStatus(
                                    "Failed (" .. triedCount .. "/" .. #candidates .. ")",
                                    "Server failed or full.\nTrying next server..."
                                )
                                Library:MakeNotify({
                                    Title       = "Treasure Hunt",
                                    Description = "Server " .. triedCount .. " failed. Trying next...",
                                    Delay       = 2,
                                })
                                task.wait(1)
                            end
                        ...
                        if not teleported and _tjState.enabled then
                            tjSetStatus(
                                "All Failed",
                                "All " .. #candidates .. " server(s) failed or full.\nRescanning in 30 seconds..."
                            )
                            Library:MakeNotify({
                                Title       = "Treasure Hunt",
                                Description = "All " .. #candidates .. " server(s) failed. Retrying in 30s...",
                                Delay       = 4,
                            })
                            local waited = 0
                            while _tjState.enabled and waited < 30 do
                                ...
                                if waited % 10 == 0 then
                                    tjSetStatus(
                                        "All Failed",
                                        "All servers failed.\nRescanning in " .. (30 - waited) .. " seconds..."
                                    )
                                end
                            end
                        end
        ...
        TreasureJoinSection:AddParagraph({
            ...
            Content = "Automatically scans the server list for a server with an active Treasure Hunt event "
                .. "and teleports to it.\n"
                .. "Tries ALL available servers one by one if previous one fails.\n"
            ...
            Callback = function()
                ...
                task.spawn(function()
                    ...
                    if #candidates > 0 then
                        ...
                        tjSetStatus(
                            "Found!",
                            #candidates .. " server(s) available!\nBest: " .. info .. " | " .. math.round(best.ping) .. "ms\nPress Teleport Now to join."
                        )
                        Library:MakeNotify({
                            Title       = "Treasure Hunt",
                            Description = #candidates .. " server(s) found! Best: " .. info .. " — Press Teleport Now to join.",
                            Delay       = 4,
                        })
                    else
